...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="listings_as_seller",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
            ],
        ...
        migrations.AddIndex(
            model_name="asset",
            index=models.Index(
                fields=["owner", "-created_at"], name="Asset_owner_i_9932c2_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="asset",
            index=models.Index(
                fields=["listing_status", "-created_at"],
                name="Asset_listing_9f34a3_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="asset",
        ...
        migrations.AddIndex(
            model_name="listing",
            index=models.Index(
                fields=["asset", "is_active", "-created_at"],
                name="Listing_asset_i_b0e279_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="transaction",
            index=models.Index(
                fields=["buyer", "-created_at"], name="Transaction_buyer_i_9c2a51_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="transaction",
            index=models.Index(
                fields=["seller", "-created_at"], name="Transaction_seller__691ff0_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="transaction",
            index=models.Index(
                fields=["asset", "-created_at"], name="Transaction_asset_i_6e80c7_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="transaction",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["user", "asset"], name="WalletHoldi_user_id_882ce7_idx"
            ),
        ),
